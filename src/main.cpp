...
{    
    ...
    cout << "Provide the start and end position's coordinates for the route.\n";
    cout << "Start's x coordinate: ";
    cin >> start_x;
    cout << "Start's y coordinate: ";
    cin >> start_y;
    cout << "End's x coordinate: ";
    cin >> end_x;
    cout << "End's y coordinate: ";
    cin >> end_y;
